...
* @return {SparkPlayer}
*/ 
Spark.prototype.getPlayer = function(){};
...
* @return {SparkPlayer}
*/ 
Spark.prototype.loadPlayer = function(playerId){};
...
* @return {SparkPlayer}
*/ 
Spark.prototype.loadPlayerByExternalId = function(externalSystem,  externalId){};
...
* @return {SparkChallenge}
*/ 
Spark.prototype.getChallenge = function(challengeInstanceId){};
...
* @param {[SparkPlayer]} players
*/ 
Spark.prototype.sendMessage = function(data,  players){};
...
* @param {[SparkPlayer]} players
*/ 
Spark.prototype.sendMessageExt = function(data,  extCode,  players){};
...
* @param {[SparkPlayer]} players
*/ 
Spark.prototype.sendMessageWithoutPush = function(data,  players){};
...
* @param {[string]} playerIds
*/ 
Spark.prototype.sendMessageById = function(data,  playerIds){};
...
* @param {[string]} playerIds
*/ 
Spark.prototype.sendMessageByIdExt = function(data,  extCode,  playerIds){};
...
* @param {[string]} playerIds
*/ 
Spark.prototype.sendMessageByIdWithoutPush = function(data,  playerIds){};
...
* @return {SparkMessage}
*/ 
Spark.prototype.message = function(extCode){};
...
* @return {bool}
*/ 
Spark.prototype.save = function(collectionName,  document){};
...
* @return {bool}
*/ 
Spark.prototype.remove = function(collectionName,  query){};
...
* @return {?}
*/ 
Spark.prototype.find = function(collectionName,  query){};
...
* @return {?}
*/ 
Spark.prototype.find_14 = function(collectionName,  query,  projection){};
...
* @param {SparkChallenge}challenge
*/ 
Spark.prototype.lock = function(challenge){};
...
* @param {SparkChallenge}challenge
*/ 
Spark.prototype.unlock = function(challenge){};
...
* @return {bool}
*/ 
Spark.prototype.lockKey = function(lockName,  tryMillis){};
...
* @return {bool}
*/ 
Spark.prototype.unlockKey = function(lockName){};
...
* @return {bool}
*/ 
Spark.prototype.unlockKeyFully = function(lockName){};
...
* @return {bool}
*/ 
Spark.prototype.hasScriptErrors = function(){};
...
* @param {?} value
*/ 
Spark.prototype.setScriptError = function(key,  value){};
...
* @return {?}
*/ 
Spark.prototype.getScriptError = function(key){};
...
* @param {string}key
*/ 
Spark.prototype.removeScriptError = function(key){};
 ...
 * 
*/ 
Spark.prototype.removeAllScriptErrors = function(){};
...
* @return {SparkLog}
*/ 
Spark.prototype.getLog = function(){};
...
* @return {[string]}
*/ 
Spark.prototype.getPlayerIds = function(){};
...
* @param {?} values
*/ 
Spark.prototype.logEvent = function(eventKey,  values){};
...
* @return {SparkHttp}
*/ 
Spark.prototype.getHttp = function(url){};
...
* @return {bool}
*/ 
Spark.prototype.dismissMessage = function(messageId){};
...
* @return {SparkMongoCollectionReadWrite}
*/ 
Spark.prototype.runtimeCollection = function(collectionName){};
...
* @return {SparkMongoCollectionReadOnly}
*/ 
Spark.prototype.metaCollection = function(collectionName){};
...
* @return {SparkFiles}
*/ 
Spark.prototype.getFiles = function(){};
...
* @return {SparkXmlReader}
*/ 
Spark.prototype.uploadedXml = function(uploadId){};
...
* @return {?}
*/ 
Spark.prototype.uploadedJson = function(uploadId){};
...
* @return {SparkXmlReader}
*/ 
Spark.prototype.downloadableXml = function(shortCode){};
...
* @return {?}
*/ 
Spark.prototype.downloadableJson = function(shortCode){};
...
* @return {SendGrid}
*/ 
Spark.prototype.sendGrid = function(username,  password){};
...
* @return {SparkScheduler}
*/ 
Spark.prototype.getScheduler = function(){};
...
* @return {SparkCache}
*/ 
Spark.prototype.getCache = function(){};
...
* @return {?}
*/ 
Spark.prototype.sendRequest = function(request){};
...
* @return {?}
*/ 
Spark.prototype.sendRequestAs = function(request,  playerId){};
...
* @return {SparkRedis}
*/ 
Spark.prototype.getRedis = function(){};
...
* @return {SparkLeaderboards}
*/ 
Spark.prototype.getLeaderboards = function(){};
...
* @return {string}
*/ 
Spark.prototype.getClientIp = function(){};
...
* @return {SparkConfig}
*/ 
Spark.prototype.getConfig = function(){};
...
* @return {SparkScriptOptions}
*/ 
Spark.prototype.getSparkScriptOptions = function(){};
...
* @return {SparkTeams}
*/ 
Spark.prototype.getTeams = function(){};
...
* @return {SparkMultiplayer}
*/ 
Spark.prototype.getMultiplayer = function(){};
...
* @return {SparkProperties}
*/ 
Spark.prototype.getProperties = function(){};
...
* @return {SparkBulkScheduler}
*/ 
Spark.prototype.getBulkScheduler = function(){};
...
* @return {SparkDigest}
*/ 
Spark.prototype.getDigester = function(){};
...
* @return {string}
*/ 
Spark.prototype.getCredentialType = function(){};
...
* @return {string}
*/ 
Spark.prototype.getSessionId = function(){};
...
* @return {SparkUploadableUtils}
*/ 
Spark.prototype.getUploadableUtils = function(){};
...
* @return {?}
*/ 
Spark.prototype.getScriptData = function(name){};
...
* @param {?} value
*/ 
Spark.prototype.setScriptData = function(name,  value){};
...
* @param {string}name
*/ 
Spark.prototype.removeScriptData = function(name){};
 ...
 * 
*/ 
Spark.prototype.removeAllScriptData = function(){};
...
* @return {number}
*/ 
Spark.prototype.getRemainingMilliseconds = function(){};
...
* @return {?}
*/ 
Spark.prototype.getData = function(){};
