...
* @return {string}
*/ 
SparkBulkScheduler.prototype.submitJobModule = function(playerQuery,  module,  data,  delaySeconds){};
...
* @return {string}
*/ 
SparkBulkScheduler.prototype.submitJobScript = function(playerQuery,  script,  data,  delaySeconds){};
...
* @return {bool}
*/ 
SparkBulkScheduler.prototype.cancelJob = function(jobId){};
...
* @return {SparkBulkJob[]}
*/ 
SparkBulkScheduler.prototype.listBulkJobs = function(jobIds){};
