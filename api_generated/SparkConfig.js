...
* @return {string}
*/ 
SparkConfig.prototype.getStage = function(){};
...
* @return {string}
*/ 
SparkConfig.prototype.getApiKey = function(){};
...
* @return {?}
*/ 
SparkConfig.prototype.getVirtualGoods = function(){};
...
* @return {SparkVirtualGood}
*/ 
SparkConfig.prototype.getVirtualGood = function(shortCode){};
...
* @return {?}
*/ 
SparkConfig.prototype.getAchievements = function(){};
...
* @return {SparkAchievement}
*/ 
SparkConfig.prototype.getAchievement = function(shortCode){};
...
* @return {?}
*/ 
SparkConfig.prototype.getSegments = function(){};
...
* @return {SparkSegmentType}
*/ 
SparkConfig.prototype.getSegment = function(shortCode){};
...
* @return {?}
*/ 
SparkConfig.prototype.getTeams = function(){};
...
* @return {SparkTeamType}
*/ 
SparkConfig.prototype.getTeam = function(shortCode){};
...
* @return {?}
*/ 
SparkConfig.prototype.getChallenges = function(){};
...
* @return {SparkChallengeType}
*/ 
SparkConfig.prototype.getChallenge = function(shortCode){};
...
* @return {SparkDownloadable}
*/ 
SparkConfig.prototype.getDownloadable = function(shortCode){};
...
* @return {[SparkDownloadable]}
*/ 
SparkConfig.prototype.getDownloadables = function(){};
...
* @return {?}
*/ 
SparkConfig.prototype.getMatchConfigs = function(){};
...
* @return {SparkMatchConfig}
*/ 
SparkConfig.prototype.getMatchConfig = function(shortCode){};
...
* @return {?}
*/ 
SparkConfig.prototype.getCurrencies = function(){};
...
* @return {SparkCurrency}
*/ 
SparkConfig.prototype.getCurrency = function(shortCode){};
