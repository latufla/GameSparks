...
* @return {string}
*/ 
SparkLeaderboardPartition.prototype.getDescription = function(){};
...
* @return {string}
*/ 
SparkLeaderboardPartition.prototype.getName = function(){};
...
* @return {string}
*/ 
SparkLeaderboardPartition.prototype.getShortCode = function(){};
...
* @return {number}
*/ 
SparkLeaderboardPartition.prototype.getEntryCount = function(){};
...
* @return {number}
*/ 
SparkLeaderboardPartition.prototype.getEntryCountForIdentifier = function(identifier){};
...
* @return {SparkLeaderboardCursor}
*/ 
SparkLeaderboardPartition.prototype.getEntries = function(){};
...
* @return {SparkLeaderboardCursor}
*/ 
SparkLeaderboardPartition.prototype.getEntries_6 = function(count,  offset){};
...
* @return {bool}
*/ 
SparkLeaderboardPartition.prototype.isPartitioned = function(){};
...
* @return {bool}
*/ 
SparkLeaderboardPartition.prototype.isPartition = function(){};
...
* @return {[SparkLeaderboardPartition]}
*/ 
SparkLeaderboardPartition.prototype.getPartitions = function(){};
 ...
 * 
*/ 
SparkLeaderboardPartition.prototype.drop = function(){};
...
* @param {bool}deleteRunningTotalData
*/ 
SparkLeaderboardPartition.prototype.drop_11 = function(deleteRunningTotalData){};
 ...
 * 
*/ 
SparkLeaderboardPartition.prototype.archive = function(){};
...
* @return {bool}
*/ 
SparkLeaderboardPartition.prototype.isArchived = function(){};
...
* @return {SparkLeaderboardEntry[]}
*/ 
SparkLeaderboardPartition.prototype.getEntriesForIdentifier = function(identifier,  customIdFilter){};
...
* @return {SparkLeaderboardCursor}
*/ 
SparkLeaderboardPartition.prototype.getEntriesFromPlayer = function(playerId,  count){};
...
* @return {SparkLeaderboardCursor}
*/ 
SparkLeaderboardPartition.prototype.getEntriesFromPlayerForCustomId = function(playerId,  count,  customIdFilter){};
...
* @return {[string]}
*/ 
SparkLeaderboardPartition.prototype.getIdFields = function(){};
...
* @return {[string]}
*/ 
SparkLeaderboardPartition.prototype.getScoreFields = function(){};
...
* @return {bool}
*/ 
SparkLeaderboardPartition.prototype.deleteAllEntries = function(identifier,  deleteRunningTotals){};
...
* @return {bool}
*/ 
SparkLeaderboardPartition.prototype.deleteEntriesForCustomId = function(identifier,  deleteRunningTotals,  customIdFilter){};
...
* @return {bool}
*/ 
SparkLeaderboardPartition.prototype.deleteEntry = function(identifier,  deleteRunningTotals){};
...
* @return {?}
*/ 
SparkLeaderboardPartition.prototype.getPropertySet = function(){};
...
* @return {number}
*/ 
SparkLeaderboardPartition.prototype.getRankForScore = function(score){};
...
* @param {bool}awardAchievements
*/ 
SparkLeaderboardPartition.prototype.rebuildLeaderboard = function(awardAchievements){};
