...
* @return {string}
*/ 
SparkMatchConfig.prototype.getShortCode = function(){};
...
* @return {string}
*/ 
SparkMatchConfig.prototype.getName = function(){};
...
* @return {string}
*/ 
SparkMatchConfig.prototype.getDescription = function(){};
...
* @return {number}
*/ 
SparkMatchConfig.prototype.getMinPlayers = function(){};
...
* @return {number}
*/ 
SparkMatchConfig.prototype.getMaxPlayers = function(){};
...
* @return {bool}
*/ 
SparkMatchConfig.prototype.getRealtime = function(){};
...
* @return {string}
*/ 
SparkMatchConfig.prototype.getRealtimeScript = function(){};
...
* @return {bool}
*/ 
SparkMatchConfig.prototype.getDropInDropOut = function(){};
...
* @return {number}
*/ 
SparkMatchConfig.prototype.getDropInDropOutExpire = function(){};
...
* @return {bool}
*/ 
SparkMatchConfig.prototype.getManuallyMatch = function(){};
...
* @return {number}
*/ 
SparkMatchConfig.prototype.getPlayerDisconnectThreshold = function(){};
...
* @return {List}
*/ 
SparkMatchConfig.prototype.getThresholds = function(){};
...
* @return {PendingMatch}
*/ 
SparkMatchConfig.prototype.createPendingMatch = function(matchGroup,  skill,  players){};
...
* @return {PendingMatch}
*/ 
SparkMatchConfig.prototype.createPendingMatchWithCustomQuery = function(matchGroup,  skill,  customQuery,  matchData,  players){};
