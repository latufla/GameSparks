...
* @return {number}
*/ 
SparkMongoCollectionReadWrite.prototype.count = function(){};
...
* @return {number}
*/ 
SparkMongoCollectionReadWrite.prototype.count_1 = function(query){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.distinct = function(key){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.distinct_3 = function(key,  query){};
...
* @param {?}keys
*/ 
SparkMongoCollectionReadWrite.prototype.dropIndex = function(keys){};
...
* @param {string}name
*/ 
SparkMongoCollectionReadWrite.prototype.dropIndexByName = function(name){};
...
* @param {?}keys
*/ 
SparkMongoCollectionReadWrite.prototype.ensureIndex = function(keys){};
...
* @param {?} optionsIN
*/ 
SparkMongoCollectionReadWrite.prototype.ensureIndex_7 = function(keys,  optionsIN){};
...
* @return {SparkMongoCursor}
*/ 
SparkMongoCollectionReadWrite.prototype.find = function(){};
...
* @return {SparkMongoCursor}
*/ 
SparkMongoCollectionReadWrite.prototype.find_9 = function(query){};
...
* @return {SparkMongoCursor}
*/ 
SparkMongoCollectionReadWrite.prototype.find_10 = function(query,  fields){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.findOne = function(){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.findOne_12 = function(query){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.findOne_13 = function(query,  fields){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.findOne_14 = function(query,  fields,  orderBy){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.findAndModify = function(query,  update){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.findAndModify_16 = function(query,  sort,  update){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.findAndModify_17 = function(query,  fields,  sort,  remove,  update,  returnNew,  upsert){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.findAndRemove = function(query){};
...
* @return {bool}
*/ 
SparkMongoCollectionReadWrite.prototype.insert = function(documents){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.aggregate = function(firstOp,  additionalOps){};
...
* @return {bool}
*/ 
SparkMongoCollectionReadWrite.prototype.applyChanges = function(existingDocument,  newDocument){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.getIndexInfo = function(){};
...
* @return {?}
*/ 
SparkMongoCollectionReadWrite.prototype.getLastError = function(){};
...
* @return {bool}
*/ 
SparkMongoCollectionReadWrite.prototype.save = function(document){};
...
* @return {bool}
*/ 
SparkMongoCollectionReadWrite.prototype.remove = function(query){};
 ...
 * 
*/ 
SparkMongoCollectionReadWrite.prototype.drop = function(){};
...
* @return {bool}
*/ 
SparkMongoCollectionReadWrite.prototype.update = function(query,  update){};
...
* @return {bool}
*/ 
SparkMongoCollectionReadWrite.prototype.update_28 = function(query,  update,  upsert,  multi){};
...
* @return {bool}
*/ 
SparkMongoCollectionReadWrite.prototype.updateMulti = function(query,  update){};
