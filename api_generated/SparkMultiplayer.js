...
* @return {string}
*/ 
SparkMultiplayer.prototype.createMatch = function(players){};
...
* @return {string}
*/ 
SparkMultiplayer.prototype.createMatchById = function(playerIds){};
...
* @return {string}
*/ 
SparkMultiplayer.prototype.createMatchWithMatchId = function(matchId,  players){};
...
* @return {string}
*/ 
SparkMultiplayer.prototype.createMatchByIdWithMatchId = function(matchId,  playerIds){};
...
* @return {SparkMatch}
*/ 
SparkMultiplayer.prototype.loadMatch = function(matchId){};
...
* @return {SparkMatchConfig}
*/ 
SparkMultiplayer.prototype.getMatchConfig = function(shortCode){};
...
* @return {PendingMatch}
*/ 
SparkMultiplayer.prototype.loadPendingMatchById = function(pendingMatchId){};
...
* @return {PendingMatch}
*/ 
SparkMultiplayer.prototype.loadPendingMatchByPlayer = function(player,  shortCode,  matchGroup){};
...
* @param {string} matchGroup
*/ 
SparkMultiplayer.prototype.cancelMatchmaking = function(player,  shortCode,  matchGroup){};
