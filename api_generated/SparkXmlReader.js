...
* @param {Function} startCallback
*/ 
SparkXmlReader.prototype.registerCallback = function(path,  startCallback){};
 ...
 * 
*/ 
SparkXmlReader.prototype.process = function(){};
...
* @return {?}
*/ 
SparkXmlReader.prototype.getElement = function(){};
...
* @return {?}
*/ 
SparkXmlReader.prototype.getXml = function(){};
